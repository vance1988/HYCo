<@ms.html5>
				...
				<!----------------------------搜索生成器表单开始------------------------------------->
					...
					<@ms.form isvalidation=true name="" id="fieldForm">
						<!--选择更新的栏目-->
							...
							<@ms.formRow label="基本搜索" style="line-height:18px">
							...
							<@ms.formRow style="line-height:7px">
									<div id="addField"></div>									
							</@ms.formRow>
						<!--生成查询表单代码按钮-->
					</@ms.form>
	...
	<!--生成代码的模态框开始-->
	<@ms.modal modalName="softModal" title="提示框标题" size="L">
		<@ms.modalBody height="400">
			<@ms.textarea name="softCode" rows="16"></@ms.textarea>
		</@ms.modalBody>
	...
	<script>
		...
		function clickZtreeId(event,treeId,treeNode){
			var url = "${managerPath}/mdiy/search/"+treeNode.categoryId+"/queryFieldName.do";
