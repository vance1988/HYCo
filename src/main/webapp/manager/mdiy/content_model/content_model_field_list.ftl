...
<@ms.modal modalName="contentModelField" title="字段设置">
	<@ms.modalBody height="400">
		<@ms.form isvalidation=true  name="fieldForm" action="${managerPath}/mdiy/contentModel/contentModelField/save.do" redirect="${managerPath}/mdiy/contentModel/contentModelField/${contentModelId}/list.do">
...
function deleteForm(fieldIds){
		var URL = base+"${baseManager}/mdiy/contentModel/contentModelField/delete.do"
