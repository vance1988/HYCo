<@ms.html5>
	...
	<@ms.panel>
		<@ms.form isvalidation=true name="appForm"  action="${base}${baseManager}/app/update.do">
...
<script>
	$(function(){
		<#if app.appId != 0>
				ms.post("${base}${baseManager}/template/queryAppTemplateSkin.do",null,function(msg){
