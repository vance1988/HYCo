<@ms.html5>
    ...
    <@ms.panel>
						...
						<#assign action="${base}${baseManager}/basic/save.do">
						<#if basic?has_content>
							...
							<#assign action="${base}${baseManager}/basic/update.do">
						</#if>    
 						<@ms.form action="${action}" name="basicForm" redirect="${base}${baseManager}/basic/${categoryId?default('0')}/list.do">
