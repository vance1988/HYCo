           		...
           		<#list folderNameList as folderName>
		        	<tr> 
			            ...
			            <td style="width:10%;text-align:center">
	                    	...
	                    	<a  class="btn btn-xs tooltips" href="${base}${baseManager}/template/showChildFileAndFolder.do?skinFolderName=templets/${websiteId}/${folderName}" data-toggle="tooltip" data-original-title="打开文件夹" >
