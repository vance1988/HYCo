 ...
 */
@Controller
@RequestMapping("/manager/mdiy/search")
public class SearchAction extends BaseAction {
	...
	public String list(ModelMap model, HttpServletRequest request) {
		...
		return Const.VIEW+"/mdiy/search/search_list";
	}
	...
	public String generateSreachFormHtml(ModelMap model, HttpServletRequest request) {
		...
		return com.mingsoft.basic.constant.Const.VIEW + "/mdiy/search/search_field";
	}
	...
	public String searchCode(@PathVariable int searchId,ModelMap model ,HttpServletRequest request){
 		...
 		model.addAttribute("searchId",searchId);
		return com.mingsoft.basic.constant.Const.VIEW+"/mdiy/search/search_code";
	}
}
